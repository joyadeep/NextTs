...
const About = (props: Props) => {
  return (
    ...
    <div className='flex flex-col gap-5'>
        ...
        <p className='text-slate-500 dark:text-slate-300'>I was born in Taplejung and studied BSc. CSIT at ACHS in Kathmandu. I have worked in different firms as a Frontend Developer.</p>
        
        <div className=' flex gap-5'>
          <Link href={"https://www.linkedin.com/in/zoysince1997/"} target='_blank'>
            <Linkedin size={24}  className='text-slate-500 hover:text-black dark:text-slate-300 dark:hover:text-slate-500 cursor-pointer'/>
          </Link>
          <Link href={"https://github.com/joyadeep"} target='_blank' >
            <Github size={24} className='text-slate-500 hover:text-black dark:text-slate-300 dark:hover:text-slate-500  cursor-pointer'  />
          </Link>
        </div>
    </div>
