...
const fomrSchame=z.object({
  content:z.string().min(1)
})



export const ChatItem = ({content,currentMember,deleted,fileUrl,id,isUpdated,member,socketQuery,socketUrl,timestamp}: Props) => {
  ...
  const form =useForm<z.infer<typeof fomrSchame>>({
    resolver:zodResolver(fomrSchame),
    defaultValues:{
      content:content
    }
  })
  ...
  const onSubmit=async(values:z.infer<typeof fomrSchame>)=>{
    try {
