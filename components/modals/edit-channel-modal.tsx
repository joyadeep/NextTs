                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
                    <div className='space-y-8 px-6'>
                        <FormField control={form.control} name='name' render={({field})=>(
                            <FormItem>
                                <FormLabel className='uppercase text-xs form-bold text-zinc-500 dark:text-secondary/70'>channel Name</FormLabel>
                                <FormControl>
                        ...
                        <FormField control={form.control} name='type' render={({field})=>(
                            <FormItem>
                                <FormLabel className='uppercase text-xs form-bold text-zinc-500 dark:text-secondary/70'>channel Type</FormLabel>
