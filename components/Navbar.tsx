...
const Navbar = (props: Props) => {
  return (
    <header className='fixed bg-white dark:bg-black top-0 z-10 flex justify-between items-center w-full px-5 md:px-20 py-3'>
      <a href='#' className= 'text-3xl font-bold tracking-tighter text-gray-800 dark:text-white w-fit whitespace-nowrap'>Joy-<span className='text-blue-500'>A</span>-deep</a>
      ...
      <NavigationMenuLink href='#contact' className='flex px-2 py-1 items-center cursor-pointer rounded-full bg-inherit text-inherit shadow-none border border-slate-300 text-md font-normal hover:bg-slate-100 dark:hover:bg-slate-700  '>Get in touch <MoveDownRight size={16} className='ml-1' /></NavigationMenuLink>
      <ModeToggle/>
      </NavigationMenu>
